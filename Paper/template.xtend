/**
	 * Barcode array to be returned which is readable by paperweb.
	 * @protected
	 */
	...
	/**
	 * Returns a barcode array which is readable by paperweb
	 * @return array barcode array readable by paperweb;
	 * @public
	 */
